...
def transform_images():
    ...
    cloud_images = transformations.data_load('images/')
    ...
    transformations.save_images(overall_cloud_images)
...
def binary_maps():
    ...
    clustering.run_kmeans(image_loc, 43900)  # sample binary map for the an image generated by the above training
    image_folder_for_binary_maps = "./generated_single_cloud_images/"

    # the third argument in the for loop should be the same value as the interval in the training phase
    # This interval is the filename of each image and allows an easy cycle through of the images
    for i in range(0, 44000, 1000):
        image_location = image_folder_for_binary_maps + str(i) + ".png"
